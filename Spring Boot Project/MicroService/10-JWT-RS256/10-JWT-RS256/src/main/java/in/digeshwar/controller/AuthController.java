...
public class AuthController {
    ...
    private final JwtUtilRs256 utilRs256;
    private final AuthenticationManager authenticationManager;
    private final RefreshTokenStore refreshTokenStore;

    public AuthController(
            JwtUtilRs256 utilRs256,
            AuthenticationManager authenticationManager,
            RefreshTokenStore refreshTokenStore
    ){

        this.utilRs256 = utilRs256;
    ...
    public ResponseEntity<Map<String, Object>> loginRefCookiesHs(
        ...
        String accessToken = utilRs256.generateToken(username);
        ...
        ResponseCookie RefreshToken = ResponseCookie.from("REFRESH_TOKEN", refreshToken)
                .httpOnly(true)
                .secure(false)          // set false for localhost & true in prod
                .sameSite("Lax")        // set Lax for localhost & Strict in prod
                .path("/")
    ...
    public ResponseEntity<Map<String, Object>> refreshCookiesRot(
        ...
        refreshTokenStore.delete(refreshToken);                   // ROTATION: delete old refresh token
        ...
        return ResponseEntity.ok(Map.of(
                "new_access_token", utilRs256.generateToken(username), // issue new access token
                "token_type", "Bearer",
